...
@everywhere begin
    ...
    const output_dir = joinpath(pwd(), "calibration_runs", "gm_1degforwardmodel_$(simulation_length)year_ecco_eccoinitial_distributed_obscov$(zonal_average ? "_zonalavg" : "")")
