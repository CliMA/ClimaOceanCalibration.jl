...
grid = jldopen(joinpath(pwd(), "examples", "GM_calibration_1degforwardmodel", "grids_and_regridder.jld2"), "r") do file
...
mkpath(dir)
start_dates = [DateTime(1997, 1, 1) DateTime(2007, 1, 1)]
...
for start_date in start_dates
    ...
    prefix = "10yearaverage_1deggrid_2degree"
