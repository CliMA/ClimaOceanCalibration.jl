...
# Output directory
output_dir = joinpath(pwd(), "calibration_runs", "catke_extratropics_$(latitude_range[end][1])_$(latitude_range[end][2])_zmin_$(z_min)_errorfrac_$(model_error_frac)_errorreg_$(error_regularizer)_priorstd_$(prior_std)_symmetric")
mkpath(output_dir)
...
covariance, Y_all = build_observation_covariance(obs_paths, zonal_average; model_error_frac, error_regularizer, latitude_range, z_min)
