...
# Output directory
output_dir = joinpath(pwd(), "calibration_runs", "catke_extratropics_$(latitude_range[end][1])_$(latitude_range[end][2])_zmin_$(z_min)_Tstd_$(T_std)_Sstd_$(S_std)_priorstd_$(prior_std)")
mkpath(output_dir)
