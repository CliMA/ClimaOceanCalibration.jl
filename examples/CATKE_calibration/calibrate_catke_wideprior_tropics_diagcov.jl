...
# Output directory
output_dir = joinpath(pwd(), "calibration_runs", "catke_lat$(latitude_range[1])to$(latitude_range[2])_zmin$(z_min)_Tstd_$(T_std)_Sstd_$(S_std)_priorstd_$(prior_std)")
mkpath(output_dir)
...
@info "  Latitude range: $latitude_range"
