# model_interface_v03.jl
#
# Thin adapter shimming the existing 2-arg ClimaCalibrate hooks in
# model_interface.jl onto the v0.3.0 AbstractModelInterface (3-arg) API.
#
# The legacy model_interface.jl requires `output_dir` to be defined as a
# global *before* it is included. Both the parent driver
# (calibrate_catke_gm_v03.jl) and the child forward-model script (see
# batched_job_body in batched_slurm_backend_v03.jl) set `output_dir`
